...
export default function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const fixed = useRef<RapierRigidBody>(RapierRigidBody.prototype);
  const j1 = useRef<RapierRigidBody>(RapierRigidBody.prototype);
  const j2 = useRef<RapierRigidBody>(RapierRigidBody.prototype);
  const j3 = useRef<RapierRigidBody>(RapierRigidBody.prototype);

  const card = useRef<RapierRigidBody>(RapierRigidBody.prototype);
